                            ...
                            <CardItem>
                              <Left>
                                ...
                                <Body>
                                  ...
                                  onPress = {() => this.props.navigation.navigate('TaskListDetail',{source: {uri: "http://" + this.props.screenProps.state.selectedClient + "."+ this.props.screenProps.state.config.DOMAIN +"/Tasklist/RunTasklist?Tasklist_ID="+item.Tasklist_ID,
                                  headers: {
                                    "managerAppToken":  this.props.screenProps.state.userData.token
                                  }},type:'Run'})
                                }
                                  ...
                                  <MaterialCommunityIcons name={'marker'} style={{margin:5}} size={20} color= {this.state.cardView && brand.colors.primary} onPress = {() => this.props.navigation.navigate('TaskListDetail',{source: {uri: "http://" + this.props.screenProps.state.selectedClient + "."+ this.props.screenProps.state.config.DOMAIN +"/Tasklist/TasklistConfig",
                                  headers: {
                                    "managerAppToken":  this.props.screenProps.state.userData.token
                                  }},type:'Configure'})
                                } />
