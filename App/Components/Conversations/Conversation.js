...
export default class ChatView extends React.Component {
  ...
  static navigationOptions = (navigate) => ({
    ...
    title: typeof(navigate.navigation.state.params)==='undefined' || typeof(navigate.navigation.state.params.title) === 'undefined' ? 'Conversation': navigate.navigation.state.params.title,
  ...
  // moved this here with try/catch because it causees the app to crash at times
  scrollToEnd = () => {
    ...
    return (
        <View style={{flexDirection: 'column'}}>
          ...
          {this.props.direction === 'left' &&
            <Text style={styles.messageBubbleLeftName}>John Lennon</Text>
          }
